...
const sections = [
  {
    ...
    content: (
      <>
        <p style={{ fontSize: '14.5px', color: '#1A1E23', marginBottom: '10px' }}>Before you begin, consider:</p>
        <ul style={{ fontSize: '14.5px', color: '#1A1E23', lineHeight: '2', paddingLeft: '20px', margin: '0 0 10px' }}>
        ...
        <p style={{ fontSize: '14.5px', color: '#1A1E23', margin: 0 }}>
  ...
  },
  {
    ...
    content: (
      <>
        <p style={{ fontSize: '15.5px', color: '#3E4851', marginBottom: '18px' }}>
          Gold jewellery comes in <span style={{ color: '#CF9D12', fontWeight: '600' }}>different purities</span>. The most common are:
        </p>
        {/* 24K */}
        <div style={{ display: 'flex', gap: '16px', marginBottom: '16px', alignItems: 'flex-start' }}>
          <div style={{ flex: 1 }}>
            <p style={{ fontWeight: '700', color: '#CF9D12', fontSize: '17px', margin: '0 0 4px', textDecoration: 'underline' }}>24K Gold</p>
            <ul style={{ fontSize: '14.5px', color: '#444', lineHeight: '1.8', paddingLeft: '18px', margin: 0 }}>
        ...
        <div style={{ display: 'flex', gap: '16px', marginBottom: '16px', alignItems: 'flex-start' }}>
          ...
          <div style={{ flex: 1 }}>
            <p style={{ fontWeight: '700', color: '#CF9D12', fontSize: '17px', margin: '0 0 4px', textDecoration: 'underline' }}>22K Gold</p>
            <ul style={{ fontSize: '14.5px', color: '#444', lineHeight: '1.8', paddingLeft: '18px', margin: 0 }}>
        ...
        <div style={{ display: 'flex', gap: '16px', marginBottom: '16px', alignItems: 'flex-start' }}>
          <div style={{ flex: 1 }}>
            <p style={{ fontWeight: '700', color: '#CF9D12', fontSize: '17px', margin: '0 0 4px', textDecoration: 'underline' }}>18K Gold</p>
            <ul style={{ fontSize: '14.5px', color: '#444', lineHeight: '1.8', paddingLeft: '18px', margin: 0 }}>
              <li>75% pure gold.</li>
        ...
        <div style={{ display: 'flex', gap: '16px', marginBottom: '16px', alignItems: 'flex-start' }}>
          ...
          <div style={{ flex: 1 }}>
            <p style={{ fontWeight: '700', color: '#CF9D12', fontSize: '17px', margin: '0 0 4px', textDecoration: 'underline' }}>14K Gold</p>
            <ul style={{ fontSize: '14.5px', color: '#444', lineHeight: '1.8', paddingLeft: '18px', margin: 0 }}>
        ...
        <p style={{ fontSize: '14.5px', color: '#444', marginTop: '16px', textAlign: 'center' }}>
  ...
  },
  {
    ...
    content: (
      <>
        <p style={{ fontSize: '14.5px', color: '#444', marginBottom: '12px' }}>
          If you are buying diamond jewellery, <span style={{ color: '#c8930a', fontWeight: '500' }}>understanding the 4 C's</span> is essential.
        </p>
        <ul style={{ fontSize: '14.5px', color: '#444', lineHeight: '2', paddingLeft: '20px', margin: '0 0 10px' }}>
        ...
        <p style={{ fontSize: '14.5px', color: '#444', margin: 0 }}>
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul style={{ fontSize: '14.5px', color: '#444', lineHeight: '2', paddingLeft: '20px', margin: '0 0 12px' }}>
        ...
        <p style={{ fontSize: '14.5px', fontWeight: '600', color: '#c8930a', marginBottom: '6px', textDecoration: 'underline' }}>Purity Guide:</p>
        <ul style={{ fontSize: '14.5px', color: '#444', lineHeight: '2', paddingLeft: '20px', margin: 0 }}>
  ...
  },
  {
    ...
    content: (
      <>
        <p style={{ fontSize: '17px', fontWeight: '800', color: '#CF9D12', marginBottom: '20px', letterSpacing: '0.5px' }}>BIS HALLMARK STAMP ON OUR JEWELLERY.</p>
  ...
  },
  {
    ...
    content: (
      <>
        <p style={{ fontSize: '14.5px', color: '#1A1E23', marginBottom: '10px' }}>Always check:</p>
        <ul style={{ fontSize: '14.5px', color: '#727989', lineHeight: '2', paddingLeft: '20px', margin: '0 0 10px' }}>
  ...
  },
  {
    ...
    content: (
      <>
        <p style={{ fontSize: '15.5px', color: '#CF9D12', fontWeight: '500', marginBottom: '24px', textAlign: 'center', textDecoration: 'underline' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '20px', textAlign: 'center', maxWidth: '1100px', margin: '0 auto' }}>
          <div>
            <p style={{ fontSize: '15.5px', fontWeight: '600', color: '#CF9D12', textDecoration: 'underline', marginBottom: '16px' }}>Daily Wear</p>
            <p style={{ fontSize: '14.5px', color: '#1A1E23', lineHeight: '1.6' }}>
              Lightweight,<br />
              Comfortable,<br />
              Simple Designs.
            </p>
          ...
          <div>
            <p style={{ fontSize: '15.5px', fontWeight: '600', color: '#CF9D12', textDecoration: 'underline', marginBottom: '16px' }}>Office Wear</p>
            <p style={{ fontSize: '14.5px', color: '#1A1E23', lineHeight: '1.6' }}>
          ...
          <div>
            <p style={{ fontSize: '15.5px', fontWeight: '600', color: '#CF9D12', textDecoration: 'underline', marginBottom: '16px' }}>Wedding & Special Occasions</p>
            <p style={{ fontSize: '14.5px', color: '#1A1E23', lineHeight: '1.6' }}>
          ...
          <div>
            <p style={{ fontSize: '15.5px', fontWeight: '600', color: '#CF9D12', textDecoration: 'underline', marginBottom: '16px' }}>Modern Style</p>
            <p style={{ fontSize: '14.5px', color: '#1A1E23', lineHeight: '1.6' }}>
              Sleek, minimalist,<br />
              rose gold tones,<br />
        ...
        <p style={{ fontSize: '15.5px', color: '#1A1E23', marginTop: '32px', textAlign: 'center' }}>
  ...
  },
  {
    ...
    content: (
      <>
        <p style={{ fontSize: '14.5px', color: '#1A1E23', marginBottom: '10px' }}>Quality craftsmanship is the foundation of durable jewellery.</p>
        <p style={{ fontSize: '14.5px', fontWeight: '600', color: '#c8930a', marginBottom: '6px', textDecoration: 'underline' }}>Look for:</p>
        <ul style={{ fontSize: '14.5px', color: '#1A1E23', lineHeight: '2', paddingLeft: '20px', margin: '0 0 10px' }}>
          <li>Smooth edges</li>
          <li>Strong clasps</li>
        ...
        <p style={{ fontSize: '14.5px', color: '#1A1E23', margin: 0 }}>Our artisans ensure every piece meets the highest standards of craftsmanship.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <div style={{ textAlign: 'center' }}>
          <p style={{ fontSize: '14.5px', fontWeight: '700', color: '#CF9D12', margin: '0 0 12px', letterSpacing: '0.5px', textDecoration: 'underline' }}>Final Word from TAMIRI JEWELLERS PVT LTD</p>
          <p style={{ fontSize: '14.5px', color: '#1A1E23', lineHeight: '1.7', margin: '0 0 20px' }}>
    ...
    <div style={{
      ...
      >
        <span style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          <span style={{ fontSize: '20px', fontWeight: '700', color: '#CF9D12', minWidth: '22px', fontFamily: "'Times New Roman', Times, serif" }}>{section.number}</span>
          <span style={{ fontSize: '20px', fontWeight: '600', color: '#CF9D12', fontFamily: "'Times New Roman', Times, serif" }}>{section.title}</span>
        </span>
